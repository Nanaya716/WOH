...
<!-- 表单 -->
<form action="/addSalesRecords" method="post" class="margin-bottom">
    ...
    <!-- 收货人 -->
    <label for="salesmanName">请填写售货员：</label>
    <input type="text" id="salesmanName" name="salesmanName" value="" required >

    <!-- 库存 -->
    <label for="quantity">请填写出货数量：</label>
    <input type="text" id="quantity" name="quantity" value="" required oninput="calculateTotalPrice()">

    <!-- 提交按钮 -->
    <button type="submit" class="button">确认出货记录</button>
</form>
